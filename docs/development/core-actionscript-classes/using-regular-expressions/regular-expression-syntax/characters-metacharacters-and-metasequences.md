...
<tbody>
    <tr>
        ...
        href="flags-and-properties">Flags and
        ...
        information, see <a
        href="character-classes">Character
        classes</a>.</p></td>
    </tr>
    <tr>
        <td><p><samp>$</samp>
    ...
    <tr>
        ...
        href="quantifiers">Quantifiers</a>.</p></td>
    </tr>
    <tr>
        <td><p><samp>+</samp>
        (plus)</p></td>
    ...
    <tr>
        ...
        and <samp>)</samp></p></td>
        <td><p>Defines groups
        within the regular expression. Use groups for the following:</p><ul class="incremental">
...
<tbody>
    ...
    <tr>
        <td><p><samp>\r</samp></p></td>
        <td><p>Matches the
        return character.</p></td>
    </tr>
    <tr>
        <td><p><samp>\s</samp></p></td>
        <td><p>Matches any
    ...
    <tr>
        <td><p><samp>\v</samp></p></td>
        <td><p>Matches a
        vertical feed character.</p></td>
    </tr>
    <tr>
        <td><p><samp>\w</samp></p></td>
        <td><p>Matches a word
