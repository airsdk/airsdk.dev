...
const DownloadButton: React.FC<DownloadButtonProps> = ({
    ...
    return (
        <Link
            className={
                highlight ? clsx('button', 'button--info', 'button--lg', styles.downloadButton, className)
                    : clsx('button', 'button--primary', 'button--xm', styles.downloadButton, className)}
            to={downloadUrl}
            target='_blank'
        >
            <i>
                ...
                >
                    <g>
                        <path fill="currentColor" d="M25.462,19.105v6.848H4.515v-6.848H0.489v8.861c0,1.111,0.9,2.012,2.016,2.012h24.967c1.115,0,2.016-0.9,2.016-2.012 v-8.861H25.462z" />
